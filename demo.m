...
switch exnum,
 ...
 case 1,
  ...
  p.components = 160;
  estimate( whiteningMatrix, dewhiteningMatrix, '../results/ica.mat', p ,iterLimit);
 ...
 case 2,
  ...
  p.stepsize = 0.1;
  p.epsi = 0.005;
  estimate( whiteningMatrix, dewhiteningMatrix, '../results/isa.mat', p ,iterLimit);
 ...
 case 3,
  ...
  p.stepsize = 0.1;
  p.epsi = 0.005;
  estimate( whiteningMatrix, dewhiteningMatrix, '../results/tica.mat', p ,iterLimit);
 ...
 case 5,
  ...
  p.algorithm = 'fixed-point';
  p.components = 40;
  estimate( whiteningMatrix, dewhiteningMatrix, '../results/ica2.mat', p ,iterLimit);
 ...
 case 6,
  ...
  p.stepsize = 0.1;
  p.epsi = 0.005;
  estimate( whiteningMatrix, dewhiteningMatrix, '../results/isa2.mat', p ,iterLimit);
 ...
 case 7,
  ...
  p.stepsize = 0.1;
  p.epsi = 0.005;
  estimate( whiteningMatrix, dewhiteningMatrix, '../results/tica2.mat', p ,iterLimit);
